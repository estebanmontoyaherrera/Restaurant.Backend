...
public class GetOrderDetailSelectHandler(IUnitOfWork unitOfWork) : IQueryHandler<GetOrderDetailSelectQuery, IEnumerable<SelectResponseDto>>
{
    private readonly IUnitOfWork _unitOfWork = unitOfWork;

    public async Task<BaseResponse<IEnumerable<SelectResponseDto>>> Handle(GetOrderDetailSelectQuery request, CancellationToken cancellationToken)
    {
